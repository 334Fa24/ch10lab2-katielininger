...
//Functionn to display the third answer
function ans3() {
    heading.style.display = "block";
...
function ans4() {
    heading.style.display = "block";
    answer.textContent = "We need volunteers to help feed the animals, care for animals, and clean animal pens. We also accept donations."
}